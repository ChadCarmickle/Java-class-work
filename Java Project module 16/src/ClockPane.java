...
public class ClockPane extends Pane {
	...
	// Clock pane's setting the width and height
	private double width = 250, height = 250;

	// Constructing a default clock with the current time the program is ran 
	public ClockPane() {
		setCurrentTime();
	}
	...
	protected void paintClock() {
		...
		mLine.setStroke(Color.DEEPPINK);
